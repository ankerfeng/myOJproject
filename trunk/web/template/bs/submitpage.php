...
?>
	...
	<script language="Javascript" type="text/javascript">
		...
		editAreaLoader.init({
		        ...
		        ,syntax: "cpp"  
		        ,font_size: "12"
		        ,syntax_selection_allow: "c,cpp,java,pas"
...
<br>
<textarea style="width:80%" cols=180 rows=20 id="source" name="source"><?php echo $view_src?>
</textarea><br>
<!--
<?php echo $MSG_Input?>:
...
-->
<input id=Submit class="" type=button value="<?php echo $MSG_SUBMIT?>"  onclick=do_submit();>
<!--
