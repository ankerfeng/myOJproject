...
<div class="nav">
   ...
   <div class="navbody">
        <div style="height:35px;line-height:35px;font-size:12px;text-align:center">
	<form id=simform action="status.php" method="get">
       	<ul> 
        <li>
	<?php echo $MSG_PROBLEM_ID?>
	:<input class="input-mini" style="height:24px" type=text size=4 name=problem_id value='<?php echo $problem_id?>'>  
        </li>
        <li>  
	<?php echo $MSG_USER?>
	:<input class="input-mini" style="height:24px" type=text size=4 name=user_id value='<?php echo $user_id?>'> 
        </li>  
        <li>
	...
	?>
		...
		echo "<input type=submit class='input'  value='$MSG_SEARCH'>";
		?>
	</li>
           </ul>
         </form>
...
<div class=center style="margin-top:10px;width:100%;">
	<table id=htr2>
